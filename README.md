...
`public Polynomial(params int[] coef)` | Creates a new instance of the Polynomial class.<br>* The integers are the coefficients.<br>* The degree is its respective index in the array.<br>Terms with 0 valued coefficients are not allowed.
